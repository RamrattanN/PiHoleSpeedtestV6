...
class WebAssetTests(unittest.TestCase):
    ...
    def test_setup_and_chart_controls_are_present(self):
        ...
        self.assertIn("measuredSpacing * 0.76", script)
        ...
        self.assertIn("function buildChartRecords(records)", script)
        self.assertIn("synthetic_zero: true", script)
        self.assertIn("download_mbps: 0", script)
        self.assertIn("timestamp < current - intervalMs / 2", script)
