...
class WebAssetTests(unittest.TestCase):
    ...
    def test_setup_and_chart_controls_are_present(self):
        ...
        self.assertIn("function chartBarGroupWidth(timeline, xPositions, index, measuredSpacing)", script)
        self.assertIn("Math.min(measuredSpacing, ...localSpacings)", script)
        self.assertIn("availableSpacing * 0.72", script)
