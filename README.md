...
Version `1.0.2` is the production maintenance line.  Its dashboard and Pi-hole
...
baseline.  Version `1.0.2` removes synthetic zero points, breaks line charts
across substantial collection outages, preserves subtle spacing between bars
across mixed collection cadences, and shows the installed version discreetly
